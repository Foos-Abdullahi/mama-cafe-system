...
import { ArrowLeft, PackagePlus, Upload, Link as LinkIcon, X } from 'lucide-react';
...
export default function ProductCreate({ categories }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (form.data.image) {
            ...
            router.post('/management/products', {
                category_id: form.data.category_id,
                name: form.data.name,
                description: form.data.description,
                price: form.data.price,
    ...
    return (
        <>
            <Head title="Add Product — MaMa Café" />
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border pb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground mt-0.5">Register a new item to your menu catalog.</p>
                        </div>
                    </div>
