    ...
    return (
        <div className="flex flex-col items-center sm:items-start text-center sm:text-left select-none">
            ...
            <div className="flex items-center gap-3 my-1">
                {/* Left Leaf Ornament */}
                <svg className="w-6 h-6 text-[#A67C52] opacity-70" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="w-9 h-9 rounded-full bg-[#FAF6EE] text-[#2B1B17] flex items-center justify-center hover:bg-[#D4AF37] hover:text-[#FAF6EE] transition-all duration-300 shadow-md"
                    aria-label="Facebook"
                >
                ...
                {/* Right Leaf Ornament */}
                <svg className="w-6 h-6 text-[#A67C52] opacity-70 transform scale-x-[-1]" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M17,8C8,10 5,16 3,21C8,20 15,17 17,8M12,14C11.5,12 13,9 16,8C14,10 13.5,12.5 12,14Z" />
                </svg>
            </div>

            {/* Handle */}
            <p className="font-sans font-bold text-sm text-[#E6C280] tracking-wider mt-2">
                @MaMacafe
            </p>
        </div>
    );
